...
- [x] 发布与源码一致的 `v0.7.3` tag 和 GitHub Release
...
1. **真实任务成功率**：历史公开评测曾记录 20 个任务、45% 成功率；该数字需要用当前 v0.7.3 重新复测，随后扩大固定任务集，并把失败分类和版本趋势放进 CI 或定期报告。
